...
Groupers species seem to not be affected by environmental or anthropogenic factors. Seabreams show different pattern when considering abiotic factor. There is a strong positive correlation between *Diplodus sargus* and *Diplodus annularis*, which is uneffected by covariates. Nevertheless, the relationship between *Diplodus vulgaris* and three other species changes when introducing abiotic factors. Herbivorous species are not affected greatly by covariates, but the strength of association is weaker when accounting for them.
