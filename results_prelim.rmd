...
model_temp_grps_nonspat <- MRFcov(data = grps_temp_mat, n_nodes = 5, n_covariates = 1,
                                  family = "gaussian")
...
# png("figures/networks/grps_allmed_temp.png", height = 450, width = 1200, res = 150)
...
```{r}
# Non-spatial model for comparison
model_mpa_grps_nonspat <- MRFcov(data = grps_mpa_mat, n_nodes = 5, n_covariates = 1,
                                  family = "gaussian")
...
# png("figures/networks/grps_allmed_mpa.png", height = 450, width = 1200, res = 150)
...
```{r}
# Non-spatial model for comparison
model_depth_grps_nonspat <- MRFcov(data = grps_depth_mat, n_nodes = 5, n_covariates = 1,
                                  family = "gaussian")
...
```{r}
# # Categorise continuous data
# grps_depth_cats <- categorise_cov(species_mat = grps_depth_mat, covariate = "depth_reg")
# 
# # Nest categorical (nominal) data
# grps_depth_cat_nested <- nested_data(categorised_data = grps_depth_cats)
# 
# # Run MRFcov model for each sub-graph
# grps_depth_cat_model <- get_model(data = grps_depth_mat, ncov = 1)
# 
# # Run model on each category
...
# 
# # png("figures/grps_allmed_depth.png", height = 450, width = 1200, res = 150)
...
# png("figures/networks/dip_allmed_temp.png", height = 450, width = 1200, res = 150)
...
# png("figures/networks/dip_allmed_mpa.png", height = 450, width = 1200, res = 150)
...
```{r}
# Non-spatial model for comparison
model_temp_herb_nonspat <- MRFcov(data = herb_temp_mat, n_nodes = length(herbivores), n_covariates = 1,
                                  family = "gaussian")
...
# png("figures/networks/herb_allmed_temp.png", height = 450, width = 1200, res = 150)
...
```{r}
# Non-spatial model for comparison
model_mpa_herb_nonspat <- MRFcov(data = herb_mpa_mat, n_nodes = length(herbivores), n_covariates = 1,
                                  family = "gaussian")
...
# png("figures/networks/herb_allmed_mpa.png", height = 450, width = 1200, res = 150)
...
```{r}
# Non-spatial model for comparison
model_depth_herb_nonspat <- MRFcov(data = herb_depth_mat, n_nodes = length(herbivores), n_covariates = 1,
                                  family = "gaussian")
...
# png("figures/networks/herb_allmed_depth.png", height = 450, width = 1200, res = 150)
...
p1 <- ggplot(med_raw, aes(enforcement)) + geom_histogram(binwidth = 1, aes(fill = ..x..)) +
  labs(x = "Level of enforcement", subtitle = "0 = No enforcement; 3 = Fully protected",
       y = "Frequency", title = "Enforcement") +
  guides(fill = FALSE)

p2 <- ggplot(med_raw, aes(mpa)) + geom_histogram(stat = "count") +
  labs(x = "MPA", subtitle = "MPAs",
       y = "Frequency", title = "Marine Protected Areas")
