...
vis_temp_pred_pair("Serranus.cabrilla", "Epinephelus.costae", grps_mat, grps_pois, groupers) %>% 
  ggsave(filename = "figures/predictions/S_cabrilla-E_costae--TEMP.png", device = "png", width = 9, height = 6, units = "in")

vis_raw_temp(spp_mat = grps_mat, "Serranus.cabrilla", "Epinephelus.costae") %>% 
  ggsave(filename = "figures/predictions/S_cabrilla-E_costae--TEMP_raw.png", device = "png", width = 9, height = 6, units = "in")
...
vis_mpa_pred_pair("Epinephelus.costae", "Epinephelus.marginatus", grps_mat, grps_pois, groupers) %>% 
  ggsave(filename = "figures/predictions/E_marginatus-E_costae--MPA.png", device = "png", width = 9, height = 6, units = "in")

vis_raw_mpa(spp_mat = grps_mat, "Epinephelus.costae", "Epinephelus.marginatus") %>% 
  ggsave(filename = "figures/predictions/E_marginatus-E_costae--MPA_raw.png", device = "png", width = 9, height = 6, units = "in")

#----
# Epinephelus.marginatus ~ Epinephelus.costae x MPA
# RI = 0.06 ; Coef = -0.05
vis_mpa_pred_pair("Epinephelus.costae", "Epinephelus.marginatus", grps_mat, grps_pois, groupers) %>% 
  ggsave(filename = "figures/predictions/E_costae-E_marginatus--MPA.png", device = "png", width = 9, height = 6, units = "in")

vis_raw_mpa(spp_mat = grps_mat, "Epinephelus.costae", "Epinephelus.costae") %>% 
  ggsave(filename = "figures/predictions/E_costae-E_marginatus--MPA_raw.png", device = "png", width = 9, height = 6, units = "in")
...
vis_temp_pred_pair("Diplodus.vulgaris", "Diplodus.sargus", dip_mat, dip_pois, diplodus) %>% 
  ggsave(filename = "figures/predictions/D_vulgaris-D_sargus--TEMP.png", device = "png", width = 9, height = 6, units = "in")

vis_raw_temp(species_i = "Diplodus.vulgaris", species_j = "Diplodus.sargus", spp_mat = dip_mat) %>% 
  ggsave(filename = "figures/predictions/D_vulgaris-D_sargus--TEMP_raw.png", device = "png", width = 9, height = 6, units = "in")
...
vis_raw_mpa(species_i = "Diplodus.vulgaris", species_j = "Diplodus.sargus", spp_mat = dip_mat) %>% 
  ggsave(filename = "figures/predictions/D_vulgaris-D_sargus--MPA_raw.png", device = "png", width = 9, height = 6, units = "in")
