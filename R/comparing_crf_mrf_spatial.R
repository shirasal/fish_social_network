...
MRFcov::cv_MRF_diag_rep(data = grps_mat, family = "poisson", n_nodes = 4, compare_null = TRUE, plot = TRUE)
...
paste("Groupers best model:", best.mod)
...
MRFcov::cv_MRF_diag_rep(data = dip_mat, family = "poisson", n_nodes = 4, compare_null = TRUE, plot = TRUE)
...
paste("Seabreams best model:", best.mod)
