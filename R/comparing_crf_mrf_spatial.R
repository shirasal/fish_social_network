...
comparison_spatial <- MRFcov::cv_MRF_diag_rep_spatial(data = grps_mat, 
                                                      ...
                                                      n_nodes = 5, 
                                                      plot = FALSE)
MRFcov::cv_MRF_diag_rep_spatial(data = grps_mat, n_covariates = 4, compare_null = TRUE, family = "poisson", n_nodes = 5, plot = FALSE)
...
MRFcov::cv_MRF_diag_rep(data = grps_mat, n_covariates = 4, compare_null = TRUE, family = "poisson", n_nodes = 5, plot = TRUE)
