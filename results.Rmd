...
```{r}
med_raw <- read_rds("data/medata.R") %>%
...
### Define variables `basin`; `group` -- disabled ATM (sourced instead)
...
spp_mat_all <- med_raw %>%
  ...
  select(groupers, tmean_reg, enforcement, depth_reg) %>% 
  na.omit(depth_reg)

groupers_model <- MRFcov(data = spp_mat_all, n_nodes = length(groupers), n_covariates = 3, family = "gaussian")
groupers_model$key_coefs$Epinephelus.costae
groupers_model$key_coefs$Epinephelus.marginatus
groupers_model$key_coefs$Mycteroperca.rubra
groupers_model$key_coefs$Serranus.cabrilla
groupers_model$key_coefs$Serranus.scriba
...
spp_mat_all <- med_raw %>%
  ...
  as.data.frame() %>% 
  `rownames<-`(make.unique(.$loc)) %>%
  select(diplodus, tmean_reg, enforcement, depth_reg) %>% 
  na.omit(depth_reg)

diplodus_model <- MRFcov(data = spp_mat_all, n_nodes = length(diplodus), n_covariates = 3, family = "gaussian")

diplodus_model$key_coefs$Diplodus.annularis
diplodus_model$key_coefs$Diplodus.puntazzo
diplodus_model$key_coefs$Diplodus.sargus
diplodus_model$key_coefs$Diplodus.vulgaris
diplodus_model$key_coefs$Diplodus.cervinus
...
spp_mat_all <- med_raw %>%
  ...
  as.data.frame() %>% 
  `rownames<-`(make.unique(.$loc)) %>%
  select(herbivores, tmean_reg, enforcement, depth_reg) %>% 
  na.omit(depth_reg)

herb_model <- MRFcov(data = spp_mat_all, n_nodes = length(herbivores), n_covariates = 3, family = "gaussian")

herb_model$key_coefs$Siganus.rivulatus
herb_model$key_coefs$Siganus.luridus
herb_model$key_coefs$Sarpa.salpa
herb_model$key_coefs$Scarus.ghobban
herb_model$key_coefs$Sparisoma.cretense

```

> I can measure the continuous data coefficient but don't know how I can quantify the MPAs
...
```{r}
# Create species matrix for `group` in `basin` with `covariate`
spp_mat <- create_spp_mat(dataset = med_raw, basin = all_med,
                          group = groupers, covariate = "tmean_reg")
str(spp_mat)
...
# png("figures/groupers_temp_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
...
spp_mat <- create_spp_mat(dataset = med_raw, basin = all_med,
                          group = groupers, covariate = "enforcement") %>% na.omit()
...
# png("figures/groupers_mpa_allmed.png", height = 450, width = 1600, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 4)
# dev.off()
...
# png("figures/groupers_depth_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
...
# png("figures/diplodus_temp_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
...
# png("figures/diplodus_mpa_allmed.png", height = 450, width = 1600, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 4)
# dev.off()
...
# png("figures/diplodus_depth_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
...
# png("figures/herb_temp_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
...
spp_mat <- create_spp_mat(dataset = med_raw, basin = all_med,
                          group = herbivores, covariate = "enforcement") %>% na.omit()
...
# png("figures/herb_mpa_allmed.png", height = 450, width = 1600, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 4)
# dev.off()
...
# png("figures/herb_depth_allmed.png", height = 450, width = 1200, res = 150)
# plot_multi_graphs(nested_df = nested_plot, n_graphs = 3)
# dev.off()
