...
```{r}
grps_temp_low_connect <- connectance(x = grps_temp_nested_mod$model[[1]]$graph, group = "groupers")
grps_temp_med_connect <- connectance(x = grps_temp_nested_mod$model[[2]]$graph, group = "groupers")
grps_temp_hi_connect <- connectance(x = grps_temp_nested_mod$model[[3]]$graph, group = "groupers")
...
```{r}
dip_temp_low_connect <- connectance(x = dip_temp_nested_mod$model[[1]]$graph, group = "diplodus")
dip_temp_med_connect <- connectance(x = dip_temp_nested_mod$model[[2]]$graph, group = "diplodus")
dip_temp_hi_connect <- connectance(x = dip_temp_nested_mod$model[[3]]$graph, group = "diplodus")
...
```{r}
herb_temp_low_connect <- connectance(x = herb_temp_nested_mod$model[[1]]$graph, group = "herbivores")
herb_temp_med_connect <- connectance(x = herb_temp_nested_mod$model[[2]]$graph, group = "herbivores")
herb_temp_hi_connect <- connectance(x = herb_temp_nested_mod$model[[3]]$graph, group = "herbivores")
...
```{r}
grps_mpa_out_connect <- connectance(x = grps_mpa_nested_mod$model[[1]]$graph, group = "groupers")
grps_mpa_in_connect <- connectance(x = grps_mpa_nested_mod$model[[2]]$graph, group = "groupers")
...
```{r}
dip_mpa_out_connect <- connectance(x = dip_mpa_nested_mod$model[[1]]$graph, group = "diplodus")
dip_mpa_in_connect <- connectance(x = dip_mpa_nested_mod$model[[2]]$graph, group = "diplodus")
...
```{r}
herb_mpa_out_connect <- connectance(x = herb_mpa_nested_mod$model[[1]]$graph, group = "herbivores")
herb_mpa_in_connect <- connectance(x = herb_mpa_nested_mod$model[[2]]$graph, group = "herbivores")
